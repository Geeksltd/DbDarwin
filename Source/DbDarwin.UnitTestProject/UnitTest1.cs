...
namespace DbDarwin.UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        public void ExtractSchema()
        {
            ...
            {
                ConnectionString =
                    "Data Source=.\\SQL2016;Initial Catalog=Source;Integrated Security=True;Connect Timeout=30",
            ...
            {
                ConnectionString =
                    "Data Source=.\\SQL2016;Initial Catalog=Target;Integrated Security=True;Connect Timeout=30",
